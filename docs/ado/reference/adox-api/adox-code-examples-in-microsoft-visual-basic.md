...
-   [Méthode Append des clés, type de clé, RelatedColumn, RelatedTable et UpdateRule, exemple de propriétés (VB)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
...
-   [Command, propriété, exemple de collection Parameters (VB)](./parameters-collection-command-property-example-vb.md)  
  
-   [Propriété CommandText, exemple de collection views (VB)](./views-collection-commandtext-property-example-vb.md)  
...
-   [Propriétés type, RelatedColumn, RelatedTable et UpdateRule, Keys, exemple de méthode Append (VB)](./keys-append-method-key-type-relatedcolumn-relatedtable-example-vb.md)  
  
-   [Propriété Name, Columns et tables Append, exemple de méthode (VB)](./columns-and-tables-append-methods-name-property-example-vb.md)  
  
-   [NumericScale et Precision, exemple de propriétés (VB)](./adox-code-example-numericscale-and-precision-properties-example-vb.md)  
...
-   [Propriété de type table, méthode de fermeture de la connexion, exemple (VB)](./connection-close-method-table-type-property-example-vb.md)  
