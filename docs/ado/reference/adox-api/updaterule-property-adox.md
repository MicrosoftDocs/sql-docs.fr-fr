---
description: UpdateRule, propriété (ADOX)
...
## <a name="remarks"></a>Notes  
 Cette propriété est en lecture seule sur les objets [clés](./key-object-adox.md) déjà ajoutés à la collection.  
