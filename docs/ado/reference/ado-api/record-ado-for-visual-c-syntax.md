---
description: Record (syntaxe ADO pour Visual C++)
title: Record (ADO pour la syntaxe Visual C++) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100020398"
---
# <a name="record-ado-for-visual-c-syntax"></a>Record (syntaxe ADO pour Visual C++)
