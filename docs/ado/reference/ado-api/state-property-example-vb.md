---
description: State, exemple de propriété (VB)
title: State, exemple de propriété (VB) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100051250"
---
# <a name="state-property-example-vb"></a>State, exemple de propriété (VB)
