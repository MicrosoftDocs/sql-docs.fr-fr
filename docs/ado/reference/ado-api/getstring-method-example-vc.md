---
description: GetString, exemple de méthode (VC++)
title: GetString, exemple de méthode (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100020809"
---
# <a name="getstring-method-example-vc"></a>GetString, exemple de méthode (VC++)
