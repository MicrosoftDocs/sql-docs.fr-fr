---
description: CacheSize, exemple de propriété (VC++)
title: CacheSize, exemple de propriété (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100036539"
---
# <a name="cachesize-property-example-vc"></a>CacheSize, exemple de propriété (VC++)
