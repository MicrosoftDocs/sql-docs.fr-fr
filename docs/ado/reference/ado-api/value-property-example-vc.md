---
description: Value, exemple de propriété (VC++)
title: Value, exemple de propriété (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100056194"
---
# <a name="value-property-example-vc"></a>Value, exemple de propriété (VC++)
