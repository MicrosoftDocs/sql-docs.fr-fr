---
description: BeginTrans, CommitTrans et RollbackTrans, exemples de méthodes (VB)
title: BeginTrans, CommitTrans et RollbackTrans, exemples de méthodes (VB) | Microsoft Docs
ms.prod: sql
