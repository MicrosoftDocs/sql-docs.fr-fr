---
description: AddNew, exemple de méthode (VC++)
title: AddNew, exemple de méthode (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "100031416"
---
# <a name="addnew-method-example-vc"></a>AddNew, exemple de méthode (VC++)
