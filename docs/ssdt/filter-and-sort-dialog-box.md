...
description: Découvrez comment modifier les données que SQL Server Data Tools affiche dans une table ou une vue. Consultez comment ajuster le nombre de lignes, l’ordre de tri et d’autres facteurs.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords:
