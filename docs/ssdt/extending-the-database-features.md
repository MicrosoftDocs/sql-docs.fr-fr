...
description: Découvrez comment étendre les fonctionnalités de base de données. Affichez des informations sur les conditions de test personnalisées, les contributeurs de build et de déploiement, ainsi que d’autres extensions de fonctionnalités.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
