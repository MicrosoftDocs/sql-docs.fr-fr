...
description: Article de modèle pour la documentation de référence Transact-SQL
ROBOTS: NOINDEX
ms.custom: ''
ms.date: 05/22/2019
ms.prod: sql
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Base de données SQL](pick-a-product-template.md?view=azuresqldb-current&preserve-view=true)
    :::column-end:::
    :::column:::
