...
### <a name="c-dropping-a-temporary-table"></a>C. Suppression d'une table temporaire  
 Cet exemple crée une table temporaire, teste son existence, la supprime et teste une nouvelle fois son existence. Cet exemple n’utilise pas la syntaxe **IF EXISTS** qui est disponible depuis [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)].  
