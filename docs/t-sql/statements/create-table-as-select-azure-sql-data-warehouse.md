...
Pour plus d’informations, consultez [Limitations et restrictions](./create-table-azure-sql-data-warehouse.md#LimitationsRestrictions) dans la rubrique CREATE TABLE.
