 ...
 **AES**  
 Indique que le point de terminaison doit utiliser l'algorithme AES. Cette option est utilisée par défaut dans [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] et versions ultérieures.  
