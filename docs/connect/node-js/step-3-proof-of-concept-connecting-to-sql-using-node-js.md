---
title: 'Étape 3 : Connexion à SQL à l’aide de Node.js'
description: Cet exemple doit être considéré comme une preuve de concept qui montre comment se connecter à SQL à l’aide de Node.js et est simplifié par souci de clarté.
ms.custom: ''
ms.date: 07/23/2019
ms.prod: sql
