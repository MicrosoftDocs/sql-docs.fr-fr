---
description: Méthode supportsOpenStatementsAcrossCommit (SQLServerDatabaseMetaData)
title: Méthode supportsOpenStatementsAcrossCommit | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsOpenStatementsAcrossCommit, est spécifiée par la méthode supportsOpenStatementsAcrossCommit de l’interface java.sql.DatabaseMetaData.  
