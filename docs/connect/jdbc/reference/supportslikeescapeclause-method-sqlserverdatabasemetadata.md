---
description: Méthode supportsLikeEscapeClause (SQLServerDatabaseMetaData)
title: Méthode supportsLikeEscapeClause (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsLikeEscapeClause est spécifiée par la méthode supportsLikeEscapeClause de l’interface java.sql.DatabaseMetaData.  
