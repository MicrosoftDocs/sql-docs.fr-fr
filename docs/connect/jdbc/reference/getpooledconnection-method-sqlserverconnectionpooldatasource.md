---
description: Méthode getPooledConnection (SQLServerConnectionPoolDataSource)
title: Méthode getPooledConnection (SQLServerConnectionPoolDataSource) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
