---
description: Méthode supportsExpressionsInOrderBy (SQLServerDatabaseMetaData)
title: Méthode supportsExpressionsInOrderBy (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsExpressionsInOrderBy est spécifiée par la méthode supportsExpressionsInOrderBy de l’interface java.sql.DatabaseMetaData.  
