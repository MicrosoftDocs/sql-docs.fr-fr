---
description: Méthode getDriverName (SQLServerDatabaseMetaData)
title: Méthode getDriverName (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
