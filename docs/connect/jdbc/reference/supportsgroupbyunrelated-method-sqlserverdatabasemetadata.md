---
description: Méthode supportsGroupByUnrelated (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Notes  
 Cette méthode supportsGroupByUnrelated est spécifiée par la méthode supportsGroupByUnrelated de l’interface java.sql.DatabaseMetaData.  
