...
description: Référence API pour la fonction PDOStatement::fetchObject dans le Pilote Microsoft PDO_SQLSRV pour PHP pour SQL Server.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
$*ctor_args* : tableau facultatif avec des arguments vers un constructeur de classe personnalisé.  
