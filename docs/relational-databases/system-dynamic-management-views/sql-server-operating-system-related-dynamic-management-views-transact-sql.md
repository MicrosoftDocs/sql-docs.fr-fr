---
description: Vues de gestion dynamique SQL Server liées au système d'exploitation (Transact-SQL)
title: SQL Server vues de gestion dynamique liées au système d’exploitation (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 04/17/2018
ms.prod: sql
ms.reviewer: ''
