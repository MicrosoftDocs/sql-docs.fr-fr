...
description: En savoir plus sur les vues de gestion dynamique SQL Server et les affichages catalogue d’objets utilisés avec In-Memory OLTP dans SQL Server.
...
[!INCLUDE[sql-asdb-asdbmi](../../includes/applies-to-version/sql-asdb-asdbmi.md)]
  ...
  Les [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] vues de gestion dynamique (DMV) suivantes sont utilisées avec In-Memory OLTP :  
...
Les affichages catalogue d’objets suivants sont utilisés spécifiquement avec In-Memory OLTP.
