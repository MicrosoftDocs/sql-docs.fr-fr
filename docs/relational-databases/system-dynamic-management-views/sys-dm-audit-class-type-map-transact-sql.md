...
|-----------------|---------------|-----------------|  
|**class_type**|**char(2)**|Type de classe de l'entité auditée. Mappe aux class_type écrites dans le journal d’audit et retournées par la fonction **get_audit_file ()** . N'accepte pas la valeur NULL.|  
