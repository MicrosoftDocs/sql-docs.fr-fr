---
description: Affichages catalogue de bases de données et de fichiers (Transact-SQL)
title: Affichages catalogue de bases de données et de fichiers (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2016
ms.prod: sql
...
ms.locfileid: "99194602"
---
# <a name="databases-and-files-catalog-views-transact-sql"></a>Affichages catalogue de bases de données et de fichiers (Transact-SQL)
