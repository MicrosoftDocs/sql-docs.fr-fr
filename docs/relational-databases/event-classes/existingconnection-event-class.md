---
description: ExistingConnection (classe d'événements)
...
## <a name="see-also"></a>Voir aussi  
 ...
 [Classe d'événements Audit Login](../../relational-databases/event-classes/audit-login-event-class.md)  
