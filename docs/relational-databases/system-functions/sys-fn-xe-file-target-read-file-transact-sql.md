...
|timestamp_utc|**datetime2**|**S’applique à** : [!INCLUDE[sssql17](../../includes/sssql17-md.md)] et versions ultérieures et [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].<br /><br />Date et heure (fuseau horaire UTC) de l’événement. N'accepte pas la valeur NULL.|  
