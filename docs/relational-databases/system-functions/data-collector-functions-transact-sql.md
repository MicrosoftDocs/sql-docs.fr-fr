---
description: Fonctions du collecteur de données (Transact-SQL)
title: Fonctions du collecteur de données (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
ms.locfileid: "98098744"
---
# <a name="data-collector-functions--transact-sql"></a>Fonctions du collecteur de données (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  Le collecteur de données utilise plusieurs fonctions pour obtenir des informations sur la collecte de données et les statistiques du collecteur de données, ou pour obtenir des données.  
  
 La table ci-après répertorie les fonctions utilisées par le collecteur de données.  
