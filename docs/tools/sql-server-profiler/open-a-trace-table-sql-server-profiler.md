---
title: Ouvrir une table de trace
titleSuffix: SQL Server Profiler
description: Découvrez comment utiliser SQL Server Profiler pour ouvrir une table dans une base de données SQL Server qui contient des résultats de trace.
ms.prod: sql
