...
description: Découvrez comment extraire des événements Transact-SQL à partir d’un fichier ou d’une table de trace dans SQL Server Profiler et les enregistrer en tant que fichier de script Transact-SQL.
ms.prod: sql
