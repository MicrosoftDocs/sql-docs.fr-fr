---
title: Arrêter une trace
titleSuffix: SQL Server Profiler
description: Découvrez comment arrêter une trace exécutée dans SQL Server Profiler, changer des propriétés et enregistrer les données capturées.
ms.prod: sql
