...
description: L’utilitaire sqlps démarre une session Windows PowerShell avec le fournisseur SQL Server PowerShell et les applets de commande chargés et inscrits.
