---
title: Propriétés de Report Server (onglet Avancé)
description: En savoir plus sur les options de l’onglet Avancé de la boîte de dialogue Propriétés du serveur de rapports, tels que le répertoire d’images mémoire et l’ID de l’instance.
