...
description: En savoir plus sur les options de l’onglet Service de la boîte de dialogue Propriétés de SQL Server Agent, tels que le chemin d’accès binaire, l’ID du processus et le mode de démarrage.
