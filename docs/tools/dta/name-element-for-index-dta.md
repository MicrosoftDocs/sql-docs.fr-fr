...
description: Dans l’utilitaire dta, l’élément Name pour les index spécifie le nom d’un index dans la configuration spécifiée par l’utilisateur.
ms.prod: sql
