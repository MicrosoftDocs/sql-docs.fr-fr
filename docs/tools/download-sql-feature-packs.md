...
| [Conseiller de mise à niveau SQL Server](../database-engine/install-windows/supported-version-and-edition-upgrades-version-15.md) | Le Conseiller de mise à niveau Microsoft analyse les instances de SQL Server en préparation de la mise à niveau vers SQL Server. |
|||
...
| Fonctionnalité | Description |
|----|-----|
| [Feature Pack Integration Services pour Azure](../integration-services/azure-feature-pack-for-integration-services-ssis.md) | Le Feature Pack Integration Services pour Azure fournit des outils permettant d’utiliser IS pour se connecter à Azure Stack. |
...
| [Complément Reporting Services pour Microsoft SharePoint](../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md)| Le complément Reporting Services pour les technologies Microsoft SharePoint vous permet d’intégrer les fonctionnalités Reporting Services à l’environnement de collaboration de SharePoint. |
...
- [Service Packs et mises à jour supplémentaires](../database-engine/install-windows/latest-updates-for-microsoft-sql-server.md)
