---
title: Fichiers include de la documentation de SQL Server
description: Explication des fichiers include de SQL Server pour le versioning et « s’applique à ».
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
ms.reviewer: ''
