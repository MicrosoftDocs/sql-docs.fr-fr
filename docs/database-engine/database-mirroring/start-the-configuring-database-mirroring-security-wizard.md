---
title: Configuration de la sécurité de mise en miroir de bases de données (Assistant)
description: Description de l’Assistant « Configurer la sécurité de la mise en miroir de bases de données » dans SQL Server Management Studio.
