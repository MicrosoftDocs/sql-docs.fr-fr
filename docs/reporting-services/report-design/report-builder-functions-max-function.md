---
title: Fonction Max (Générateur de rapports) | Microsoft Docs
description: Découvrez la fonction Max, qui retourne la valeur maximale de toutes les valeurs numériques non Null spécifiées par l’expression dans le Générateur de rapports.
ms.date: 03/07/2017
