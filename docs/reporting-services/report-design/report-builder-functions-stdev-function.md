---
title: Fonction StDev (Générateur de rapports) | Microsoft Docs
description: La fonction StDev dans le Générateur de rapports retourne l’écart type de toutes les valeurs numériques non Null spécifiées par une expression.
ms.date: 03/07/2017
...
ms.locfileid: "98597165"
---
# <a name="report-builder-functions---stdev-function"></a>Fonctions du Générateur de rapports - StDev
