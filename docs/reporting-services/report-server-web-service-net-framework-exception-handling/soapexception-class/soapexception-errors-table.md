...
description: Découvrez les erreurs qui peuvent se produire avec les méthodes par le biais d’un SoapException dans le service Web Report Server.
ms.date: 03/16/2017
