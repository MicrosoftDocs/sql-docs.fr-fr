...
title: Limitations NOT NULL | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "99185174"
---
# <a name="not-null-limitations"></a>NOT NULL, limitations
La contrainte NOT NULL dans l’instruction CREATE TABLE n’est pas prise en charge.
